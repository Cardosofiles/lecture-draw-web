...
import { ChevronDown, ChevronRight, Terminal as TerminalIcon, X } from 'lucide-react'
        ...
        >
          {lines.map((line, i) => (
            <div key={i} style={{ display: 'flex', gap: '4px' }}>
              <span
                style={{
                  color: line.output ? 'var(--vscode-text-mute)' : 'var(--vscode-green)',
                }}
              >
                {line.prompt}
              </span>
              <span
                style={{
                  color: line.output ? 'var(--vscode-text-muted)' : 'var(--vscode-text)',
                }}
              >
                {line.command}
              </span>
