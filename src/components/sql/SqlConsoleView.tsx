            ...
            {openTables[table] && (
              <div>
                {cols.map((c) => (
                  ...
                  >
                    <span>{c.column}</span>
                    <span style={{ color: "var(--vscode-text-mute)" }}>
                      :{c.type}
                    </span>
                  </div>
                ))}
            ...
            {result && (
              ...
              >
                ...
                >
                  <CheckCircle2
                    size={14}
                    style={{ color: "var(--vscode-green)" }}
                  />
                  <span
                    style={{ color: "var(--vscode-green)", fontWeight: 600 }}
                  >
                    {result.message}
                  </span>
                  <span
            ...
            {history.map((entry) => (
              ...
              >
                {entry.error ? (
                  <AlertTriangle
                    size={11}
                    style={{ color: "var(--vscode-red)", flexShrink: 0 }}
                  />
                ) : (
                  <CheckCircle2
                    size={11}
                    style={{ color: "var(--vscode-green)", flexShrink: 0 }}
                  />
                )}
                <span
                  style={{
