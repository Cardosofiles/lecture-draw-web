  ...
  if (userPrize?.transferredToId) {
    return (
      <div style={{ padding: '32px', maxWidth: '600px' }}>
        ...
        >
          <Gift size={48} style={{ color: 'var(--vscode-orange)', margin: '0 auto 16px' }} />
          <h2
            style={{
          ...
          <p style={{ fontSize: '14px', color: 'var(--vscode-text-muted)' }}>
            ...
            para{' '}
            <strong style={{ color: 'var(--vscode-text)' }}>{userPrize.transferredTo?.name}</strong>
            .
          </p>
        </div>
      </div>
  ...
  if (!userPrize) {
    return (
      <div style={{ padding: '32px', maxWidth: '600px' }}>
        ...
        >
          <span style={{ color: 'var(--vscode-orange)' }}>Transferir</span> Prêmio
        </h1>
        <div
          style={{
            background: 'linear-gradient(135deg, #070e1d 0%, #0a1528 100%)',
        ...
        >
          <Gift size={48} style={{ color: 'var(--vscode-text-mute)', margin: '0 auto 16px' }} />
          <h2
            style={{
              fontFamily: 'var(--font-display)',
              fontSize: '18px',
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '13px', color: 'var(--vscode-text-muted)' }}>
            ...
            filtered.map((p) => (
              <button
                ...
                style={{
                  ...
                  width: '100%',
                  padding: '10px 14px',
                  background: selected?.id === p.id ? 'var(--vscode-accent-ghost)' : 'transparent',
                  border: 'none',
              ...
              >
                ...
                {selected?.id === p.id && (
                  <Check size={16} style={{ color: 'var(--vscode-accent)', flexShrink: 0 }} />
                )}
              </button>
            ))
          )}
        ...
        >
          <ArrowRight size={18} />
          {selected ? `Transferir para ${selected.name}` : 'Selecione um destinatário'}
        </motion.button>
      </motion.div>
            ...
            >
              ...
              <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                ...
                >
                  ...
                  para <strong style={{ color: 'var(--vscode-text)' }}>{selected.name}</strong>
                  .
                  <br />
                  <span style={{ color: 'var(--vscode-red)', fontSize: '12px' }}>
