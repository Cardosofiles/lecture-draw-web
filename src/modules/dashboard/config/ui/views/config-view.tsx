...
import { authClient, useSession } from '@/modules/auth/data/auth-client'
...
/**
 * Perfil do participante e a zona de exclusão de conta (BR-22..BR-24).
 *
 * A sessão vem do `useSession()` do cliente, e não de prop, porque a tela
 * precisa refletir o logout na hora — `signOut()` acontece aqui mesmo.
 */
